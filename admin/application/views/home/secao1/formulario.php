...
<div class="wrapper wrapper-content animated">
  <form action="<?php echo base_url(array('home', 'salvar', 'secao1')) ?>" method="post" id="form-cadastro-noticia" enctype="multipart/form-data">
    <div class="row">
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                <div class="ibox-content">
                        ...
                        <div class="row">
                                ...
                                <div class="col-sm-12 preview-image">
                                    <div id="img-S1" class="lightBoxGallery">
                                        <?php if (isset($pagina->imagem)): ?>
                                            <img id="img-show-S1" src="<?php echo base_url(array('../', 'public', 'imagens', 'home', $pagina->imagem)) ?>">
                                        <?php endif ?>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6 col-xs-6">
                                  <div class="form-group">
                                      ...
                                      <textarea name="texto" class="form-control summernote" rows="4"><?php echo (isset($pagina->texto)) ? $pagina->texto : '' ?></textarea>
                                  </div>
                                  <div class="form-group">
                                      <label class="control-label">Link Botão:</label>
                                      <input type="text" name="link" class="form-control" value="<?php echo (isset($pagina->link)) ? $pagina->link : '' ?>">
                                  </div>
                              </div>
                        </div>
                        <br><br>
                        ...
                        <?php if (isset($pagina->imagem)): ?>
                            <input type="hidden" name="imagem_secao" value="<?php echo $pagina->imagem ?>">
                        <?php endif ?>
                        <div class="hr-line-dashed"></div>
                        <div class="row">
