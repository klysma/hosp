            ...
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    ...
                    <div class="ibox-tools">
                        ...
                        <a class="btn btn-primary" href="<?php echo base_url(array('home', 'comentarios', 'novo')) ?>">
                            ...
                            ?>
                                        <tr class="gradeC" id="item-<?php echo $comentario->id ?>">
                                            ...
                                            <td class="text-center">
                                                ...
                                                <a href="<?php echo base_url(['home', 'comentarios', 'editar']) ?>?id=<?php echo $comentario->id ?>" class="btn btn-default btn-icon-action" data-toggle="tooltip" data-placement="bottom" title="Editar"><i class="fa fa-pencil-square-o"></i></a>
                                                <a href="<?php echo base_url(['home', 'comentarios', 'excluir']) ?>" class="btn btn-default btn-icon-action delete-item" data-item="<?php echo $comentario->id ?>" data-toggle="tooltip" data-placement="bottom" title="Excluir"><i class="fa fa-trash"></i></a>
                                            </td>
                                        </tr>
                            <?php
                                    }
